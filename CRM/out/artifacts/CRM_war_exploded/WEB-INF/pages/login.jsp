	...
	<table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1" >
		...
		<tr align="center" >
			...
			<td class="login_msg" width="400">
				<s:form action="staff_login" namespace="/">
					...
					<br/>
					用户名：
					<s:textfield name="crmStaff.loginName" value="%{#request.loginName}" cssClass="msg"/>
					<br/><br/>
					密&nbsp;码：
					<s:password name="crmStaff.loginPwd" cssClass="msg"/>
					<br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
