...
<form action="${pageContext.request.contextPath}/WEB-INF/pages/graduate/listGraduate.jsp" method="post">
	  ...
	  <tr>
	    ...
	    <td width="19%">
	    	...
	    	<select name="crmStudent.crmClass.classId"  onchange="changeStudent(this)">
			    ...
			    <option value="b828f351bc8343d698c0934f0c000001">J161001期</option>
			    <option value="b828f351bc8343d698c0934f0c000002">J161102期</option>
			    <option value="b828f351bc8343d698c0934f0c000003">D161101期</option>
			</select>
