...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('010301','0103','班级管理','${pageContext.request.contextPath}/classes_findAll','','right');
		d.add('010302','0103','课程类别','${pageContext.request.contextPath}/courseType_findAll?nowPageIndex=1','','right');
		d.add('0104','01','就业部');
		d.add('010401','0104','就业情况','${pageContext.request.contextPath}/pages/graduate/listGraduate.jsp','','right');
		d.add('0105','01','人力资源部');
		d.add('010501','0105','部门管理','${pageContext.request.contextPath}/department_findAllDepartment?nowPageIndex=1','','right');
		d.add('010502','0105','职务管理','${pageContext.request.contextPath}/post_findAllPost?nowPageIndex=1','','right');
		d.add('010503','0105','员工管理','${pageContext.request.contextPath}/staff_findAll?nowPageIndex=1','','right');
