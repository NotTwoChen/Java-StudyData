						...
						<div align="right">
							<table border="0" width="215" cellspacing="0" cellpadding="0" id="table6" height="23">
								<tr>
									<td width="51" valign="middle">
										<font color="#FFFFFF">
											欢迎您： ${sessionScope.crmStaff.staffName}
										</font>
									</td>
								</tr>
							</table>
							...
							<table border="0" width="215" cellspacing="0" cellpadding="0" id="table6" height="23">
								<tr>
									<td width="51" valign="middle">
										...
										--%>
										<a href="${pageContext.request.contextPath}/WEB-INF/pages/staff/updPwd.jsp" target="right">
											<font color="ffffff">更改密码</font>
										</a>
									</td>
										<td width="55" valign="middle"><a href="${pageContext.request.contextPath}/staff_logout.action" target="_top"><font color="ffffff">重新登录</font></a></td>
								</tr>
							</table>
						</div>
						</td>
