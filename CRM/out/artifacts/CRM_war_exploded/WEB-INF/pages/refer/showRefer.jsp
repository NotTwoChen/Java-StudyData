...
<table border="0" cellspacing="0" cellpadding="0"  class="wukuang"width="100%">
  <tr>
    ...
    <td width="52%"align="right">
       <%--退回 --%>
       <a href="${pageContext.request.contextPath}/WEB-INF/pages/refer/listRefer.jsp?status=1">
...
<table width="89%" class="emp_table"    style="" align="left" cellspacing="0">
  ...
  <tr>
    <td>跟踪信息：</td>
    <td>
    	<a href="${pageContext.request.contextPath}/WEB-INF/pages/follow/addOrEditFollow.jsp">添加跟踪</a>
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
