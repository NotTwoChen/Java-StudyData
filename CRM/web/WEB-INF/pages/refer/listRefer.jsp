...
<table border="0" cellspacing="0" cellpadding="0" class="wukuang">
  <tr>
    ...
    <td width="63%"align="right">
    	<%--添加咨询 --%>
    	<a class="butbg" href="${pageContext.request.contextPath}/WEB-INF/pages/refer/addRefer.jsp">
...
<table width="100%" border="1" >
  ...
  <tr class="tabtd1">
		...
		<td width="8%" align="center">
			<a href="${pageContext.request.contextPath}/WEB-INF/pages/refer/showRefer.jsp"><img src="${pageContext.request.contextPath}/images/button/view.gif" class="img"/></a>
		</td>
		
		
		<!-- 编辑 -->
		<td width="8%" align="center">
			<a href="${pageContext.request.contextPath}/WEB-INF/pages/refer/editRefer.jsp"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
		</td>
		
		<!-- 添加跟踪 -->
		<td width="8%" align="center">
			<a href="${pageContext.request.contextPath}/WEB-INF/pages/follow/addOrEditFollow.jsp"><img src="${pageContext.request.contextPath}/images/button/new.gif" class="img"/></a>
		</td>
		
		<!-- 入学 -->
		<td width="8%" align="center">
			<a href="${pageContext.request.contextPath}/WEB-INF/pages/refer/addStudent.jsp"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
		</td>
