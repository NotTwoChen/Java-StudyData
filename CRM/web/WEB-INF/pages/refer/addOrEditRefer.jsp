...
<s:form namespace="/refer" action="referAction_addOrEdit">
	...
	<table width="89%" class="emp_table"    style="" align="left" cellspacing="0">
	  ...
	  <tr>
	    <td>意向级别：</td>
	    <td>
	    	<s:select list="@com.denny.crm.constant.CommonConstant@REFER_INTENTION_LEVEL" name="intentionLevel" headerKey="" headerValue="--请选择意向级别--"></s:select>
	    </td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    ...
	    <td align="left">
	    	<s:select list="@com.denny.crm.constant.CommonConstant@REFER_SOURCE" name="source" headerKey="" headerValue="--请选择来源--"></s:select>
