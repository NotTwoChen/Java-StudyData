  ...
  <tr>
    ...
    <td width="57%"align="right">
       ...
       <a href="#"><img src="${pageContext.request.contextPath}/images/button/gaojichaxun.gif" /></a>
  		--%>
    	<%--添加 --%>
  		<a href="${pageContext.request.contextPath}/WEB-INF/pages/graduate/addOrEditGraduate.jsp">
	 ...
	 <tr class="tabtd2">
	    ...
	    <td align="center">手动方式 </td>
	  	...
	  	<td width="7%" align="center">
	  		<a href="${pageContext.request.contextPath}/WEB-INF/pages/graduate/addOrEditGraduate.jsp"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img" /></a>
	  	</td>
	  </tr>
