...
<table border="0" cellspacing="0" cellpadding="0"  class="wukuang"width="100%">
  <tr>
    ...
    <td width="57%"align="right">
    	...
    	<%--添加 --%>
    	<a href="${pageContext.request.contextPath}/WEB-INF/pages/student/addOrEditStudent.jsp">
...
<!-- 查询条件：添加或选择马上查询 -->
<form action="${pageContext.request.contextPath}/WEB-INF/pages/student/listStudent.jsp" method="post">
    ...
    <td width="10%" align="center">状态</td>  <!-- 新生、转班、升级、退费、毕业 -->
  	...
  	<td width="5%" align="center">流失</td>
	   ...
	   <tr class="tabtd1">
	    ...
	    <td align="center">
	    	<a href="${pageContext.request.contextPath}/WEB-INF/pages/student/addOrEditStudent.jsp"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
	    </td>
	    
	    <td align="center">
	    	<a href="${pageContext.request.contextPath}/WEB-INF/pages/station/editStation.jsp"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
    	</td>
    	<!-- 查询详情 -->
		<td align="center">
			<a href="${pageContext.request.contextPath}/WEB-INF/pages/student/showStudent.jsp"><img src="${pageContext.request.contextPath}/images/button/view.gif" class="img"/></a>
		</td>
		
	    <td align="center">
			<a href="${pageContext.request.contextPath}/WEB-INF/pages/runoff/addRunoff.jsp"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img"/></a>
	    </td>
	  </tr>
