...
<s:form action="classes_upload" method="post" enctype="multipart/form-data">
	<s:hidden name="crmClasses.classId" value="%{#request.crmClasses.classId}"/>
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  <tr>
	    <td width="120">课程类别：</td>
	    <td><s:property value="%{#request.crmClasses.crmCourseType.courseName}"/></td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>班级：</td>
	    <td><s:property value="%{#request.crmClasses.name}"/></td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>上次上传时间：</td>
	    <td><s:property value="%{#request.crmClasses.beginTime}"/></td>
	    <td>&nbsp;</td>
	  </tr>
	  <tr>
	    <td>选择课表：</td>
