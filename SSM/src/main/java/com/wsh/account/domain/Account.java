package com.wsh.account.domain;
...
public class Account {
    ...
    private Account recommenderAccount;
    ...
    public Account getRecommenderAccount() {
        return recommenderAccount;
    }

    public void setRecommenderAccount(Account recommenderAccount) {
        this.recommenderAccount = recommenderAccount;
    }
